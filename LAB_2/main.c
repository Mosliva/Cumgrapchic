...
void Init()
{
Menu_AddButton("Sprite", 10, 10, 200, 60, 2); // First button starts at the left, position unchanged
Menu_AddButton("Hide", 220, 10, 200, 60, 2);  // Second button is placed right next to the first
Menu_AddButton("Exit", 430, 10, 200, 60, 2);  // Third button follows the second

     textureSprite1 = LoadTexture("sprite.png");
