...
void DisableOpenGL(HWND, HDC, HGLRC); // Объявление функции DisableOpenGL
...
void Init()
{
    Menu_AddButton("Jump", 10, 10, 200, 60, 2);
    Menu_AddButton("IDLE", 220, 10, 200, 60, 2);
    Menu_AddButton("Exit", 430, 10, 200, 60, 2);

    textureSprite1 = LoadTexture("Jump.png");
    textureSprite2 = LoadTexture("IDLE.png");
}
                   ...
                   int nCmdShow)
{
    ...
    while (!bQuit)
    {
        ...
        else
        {
            ...
            glClearColor(0.8f, 0.8f, 0.6f, 0.1f);
            ...
            {
                float sprite1PosX = centerX + characterPosX; // учтем смещение персонажа
                float sprite1PosY = posY + characterPosY; // учтем смещение персонажа
            ...
            {
                float sprite2PosX = centerX + characterPosX; // учтем смещение персонажа
                float sprite2PosY = posY + characterPosY; // учтем смещение персонажа
        ...
        case WM_KEYDOWN:
            {
                switch (wParam)
                {
                    case VK_ESCAPE:
                        ...
                        break;
                    case VK_LEFT:
                        characterPosX -= 5.0f; // Смещаем персонажа влево
                        break;
                    case VK_RIGHT:
                        characterPosX += 5.0f; // Смещаем персонажа вправо
                        break;
                    case VK_UP:
                        characterPosY -= 5.0f; // Смещаем персонажа вверх
                        break;
                    case VK_DOWN:
                        characterPosY += 5.0f; // Смещаем персонажа вниз
                        break;
                }
                break;
            }
